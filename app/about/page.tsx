                        ...
                        <div className="relative w-fit">
                            <div className="relative flex flex-row z-20">
                                ...
                                " target="_blank" rel="noreferrer">
                                    ...
                                    <p className="text-xl lg:text-2xl text-light-color dark:text-primary-color font-manjari">CURRICULUM</p>
                                </a>
                            </div>
                        </div>
                        <div className="relative w-fit">
                            <div className="relative flex flex-row z-20">
                                ...
                                " target="_blank" rel="noreferrer">
                                    <GrCertificate className="text-xl lg:text-2xl text-light-color dark:text-primary-color "/>
                                    <p className="text-xl lg:text-2xl text-light-color dark:text-primary-color font-manjari">RESUME (EN)</p>
                                </a>
                            </div>
                        </div>
                    </div>
